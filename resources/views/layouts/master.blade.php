...
<div id="app" class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg">UMTC Scheduler</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('layout/umtcProfile.jpeg')}}" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
            <img src="{{asset('layout/umtcProfile.jpeg')}}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <router-link to="/results" class="nav-link" > <i class="fa fa-file"></i> <span>Results</span> </router-link>
        </li>
        <li class="treeview">
